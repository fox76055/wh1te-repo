...
reagent-desc-brennnight = Выглядит немного демонически, немного магически. Очень алкогольный напиток с ярким привкусом перца.

reagent-name-maxwell = Напиток "Анна'Наваар"
reagent-desc-maxwell = По вкусу больше похож на водку чем сама водка.

reagent-name-faustnetzach = Напиток "FaustNetzach"
reagent-desc-faustnetzach = Лёгкая морозная свежесть с первых глотков, за которой внезапно раскрывается тонкий аромат фиалок.
