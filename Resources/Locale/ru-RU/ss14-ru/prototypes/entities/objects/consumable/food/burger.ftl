...
ent-FoodCottonBunBottom = нижняя хлопковая булочка
    .desc = Пришло время начать волокнистую бургерную башню.
ent-FoodCottonBunTop = верхняя хлопковая булочка
    .desc = Идеальное завершение для вашей волокнистой бургерной башни.
ent-FoodBunCotton = хлопковая булочка
    .desc = Булочка для бургера из волокнистого хлопка.
ent-FoodBurgerCotton = хлопковый бургер
    .desc = Почему моли тоже не могут наслаждаться хорошим бургером?
ent-FoodBurgerCottonCheese = хлопковый чизбургер
    .desc = Сыр и хлопок между булочками — простое наслаждение для моли.
